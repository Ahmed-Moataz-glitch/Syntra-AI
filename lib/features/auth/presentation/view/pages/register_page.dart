                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: rolesList[index].isSelected
                              ?  isLightMode ? AppColors.fillColor : AppColors.primary.withAlpha(240)
                              : null,
                          border: Border.all(
                            color: rolesList[index].isSelected
                                ? !isLightMode ? AppColors.transparent : AppColors.primary
                      ...
                      GradientButtonWidget(
                        ...
                        onPressed: () async {
                          if (formKey.currentState!.validate() &&
                              ...
                              isTermsAccepted) {
                            // debugPrint('Email: ${emailController.text}, Password: ${passwordController.text}, Full Name: ${fullNameController.text}, Role: $selectedRole');
