...
import 'package:syntra_ai/features/home/presentation/view/widgets/secondary_gradient_button_widget.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text.rich(
                TextSpan(
                  text: AppLocalization.isArabic() ? '${S.of(context).home_page_title1} ' : S.of(context).home_page_title1,
                  ...
                  children: [
                    WidgetSpan(
                      ...
                      child: Container(
                        margin: AppLocalization.isArabic() ? EdgeInsets.only(left: 8.w) : null,
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.headlineMedium!.copyWith(
                  fontSize: 16.sp,
                  color: isLightMode ? null: AppColors.primary.withAlpha(170),
                ),
                // style: TextStyle(
                //   fontSize: 16.sp,
              ...
              SizedBox(height: size.height * 0.03),
              Divider(
                color: isLightMode ? AppColors.dividerColor.withValues(alpha: 100) : AppColors.primary.withAlpha(60),
                  // indent: 16.w,
                  // endIndent: 16.w,
          ...
          child: Container(
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme.displayLarge!.copyWith(
                fontSize: 18.sp,
                color: isLightMode ? null : AppColors.purple.withAlpha(220),
                fontWeight: FontWeight.bold,
              ),
